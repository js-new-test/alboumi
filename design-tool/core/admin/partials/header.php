...
<html lang="en">
	<head>
		...
		<title><?php echo (isset($title) ? $title : 'Alboumi Design Tool'); ?></title><?php
}
...
?>
	...
	<div class="lumise_sidebar">
		<div class="lumise_logo">
			<a href="<?php echo $lumise->cfg->admin_url.'lumise-page=system'; ?>" title="<?php echo $lumise->lang("Home"); ?>"><img src="<?php echo $lumise->cfg->admin_assets_url;?>images/logo.png"></a>
