...
class lumise_views extends lumise_lib {
	...
	<ul data-block="left" data-resp="file">
		...
		<li data-tool="file" data-view="list">
			...
			<ul data-view="sub" id="lumise-file-nav">
				...
				<li data-view="sp"></li>
				<li data-func="save" style="display: none;">
				...
				?>
					<li data-func="saveas" style="display: none;">
	...
	<ul data-block="right">
		...
		if(empty($active_lang)) $active_lang = "en";
		...
		?>
		<li id="back-btn">
			<a href="<?php echo $_SESSION['cartmaindata']['backurl']; ?>" class="back_shop"><?php echo $this->main->lang('Back To Shop'); ?></a>
		</li>
		<?php } ?>
