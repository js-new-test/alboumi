	 ...
	 extends : {
		 ...
		 controls : {
			 ...
			 drawControls: function(ctx) {
				 ...
				 if (this.hasRotatingPoint) {
					 ...
					 if (active !== null && active.get('lockPosition') === true) {
						 ...
						 ctx.fillStyle = invert == '#b80000' ? '#777' : '#ccc';
						 ...
						 Object.keys(pos).map(function(p){
							 ctx.drawImage(
								 lumise.objects.icons[(invert == '#b80000' || p == 'del' ? '' : 'w')+p],
								 pos[p][0],
								 pos[p][1],
								 c, c
							 );
			 ...
			 drawBorders: function(ctx) {
				 ...
				 ctx.save();
				 ctx.strokeStyle = lumise.get.color('invert') == '#b80000' ? 'rgba(30, 30, 30, 0.35)' : 'rgba(230, 230, 230, 0.6)';
