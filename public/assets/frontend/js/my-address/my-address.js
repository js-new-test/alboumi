$('#country').on('change', function(){
    ...
    $.ajax({
        url: baseUrl + '/customer/states/' + country,
        method: "GET",
...
$(document).on('change', '#states', function(){    
    ...
    var baseUrl = $('#baseUrl').val();       
    $.ajax({
        url: baseUrl + '/customer/cities/' + cities,
        method: "GET",
        success: function(response) {            
            if(response)
            {                    
...
$(document).on('click', '#change_defalut_address', function(){
    ...
    var baseUrl = $('#baseUrl').val();
    $.ajax({
        url: baseUrl + '/customer/change-default-address',
        method: "POST",
        data: {
            "_token": $('#token').val(),
...
$(document).on('click', '#delete_address', function(){
    ...
    var baseUrl = $('#baseUrl').val();
    $.ajax({
        url: baseUrl + '/customer/delete-address',
        method: "POST",
        data: {
            "_token": $('#token').val(),
            address_id: address_id,        
...
$(document).on('click', '.edit-address', function() {        
    ...
    var baseUrl = $('#baseUrl').val();
    $.ajax({
        url: baseUrl + '/customer/get-ajax-address',
        method: "POST",
        data: {
            "_token": $('#token').val(),
            address_id: address_id,        
