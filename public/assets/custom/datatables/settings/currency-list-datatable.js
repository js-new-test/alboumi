$(document).ready(function() {    
    ...
    var table = $('#currency_list').DataTable({
        ...
        "initComplete": function (settings, json) {  
            $("#currency_list").wrap("<div style='overflow:auto; width:100%;position:relative;'></div>");            
        },
        order: [[ 4, "desc" ]],
        ajax: {
        ...
        columns: [
            ...
            {data: 'id', name: 'id', 
                ...
                {                    
                    ...
                    output += '<a href="javascript:void(0);" class="currency_delete text-danger"><i class="fa fa-trash" aria-hidden="true"></i></a>'
                    return output;
                }
            },                                 
        ],
