<?php
	...
	{
		$successUrl = EVENTPHOTO_SUCCESS_URL . "?track_id=".$trackID."&payment_id=".$paymentID.$mobileVar;

		echo("REDIRECT=$successUrl");
	...
	else if ($myObj->getResult() == "NOT CAPTURED" || $myObj->getResult() == "CANCELED" || $myObj->getResult() == "DENIED BY RISK" || $myObj->getResult() == "HOST TIMEOUT")
	{
		if ($myObj->getResult() == "NOT CAPTURED")
		{
			...
			$cancelUrl = EVENTPHOTO_CANCEL_URL . "?track_id=".$trackID."&error=".$response.$mobileVar;

			echo("REDIRECT=$cancelUrl");
	...
	else
	{
		...
		$cancelUrl = EVENTPHOTO_CANCEL_URL . "?track_id=".$trackID."&error=".$errorText.$mobileVar;
