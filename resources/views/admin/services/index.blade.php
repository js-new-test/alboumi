...
<title>Our Services | Alboumi</title>
...
<div class="app-container app-theme-white body-tabs-shadow fixed-header fixed-sidebar closed-sidebar">
        ...
        <div class="app-main__outer">
            <div class="app-main__inner">
                    ...
                    <div class="page-title-wrapper">
                        ...
                        <div class="page-title-actions">
                            <div class="d-inline-block dropdown">
                                <a href="{{url('/admin/services/addService')}}">
                                    <button class="mb-2 mr-2 btn-icon btn-square btn btn-primary btn-sm">
                                        <i class="fa fa-plus btn-icon-wrapper"> </i>New Service
                                    </button>
                                </a>
                        ...
                        <form method="post">
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    ...
                                    <select name="filter_service" id="filter_service" class="multiselect-dropdown form-control">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <button type="button" id="filter_service" class="btn btn-primary desktop-filter-search-btn mobile-filter-search-btn">Search</button>
                                </div>
                            </div>
                        </form>
                    </div>
                ...
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        <table style="width:100%;" id="services_listing"
    ...
    <div class="modal" id="serviceDeleteModel" tabindex="-1" role="dialog" aria-labelledby="serviceDeleteModelLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <input type="hidden" name="serviceIdForDelete" id="serviceIdForDelete">
    ...
    <!-- active inactive service modal -->
    <div class="modal" id="serviceActiveInactiveModel" tabindex="-1" role="dialog" aria-labelledby="serviceActiveInactiveModelLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Confirmation</h5>
                ...
                <div class="modal-body">
                    <input type="hidden" name="serviceIdForActiveInactive" id="serviceIdForActiveInactive">
