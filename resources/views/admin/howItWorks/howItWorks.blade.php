        ...
        <div class="app-main__outer">
            <div class="app-main__inner">
                    ...
                    <div class="page-title-wrapper">
                        ...
                        <div class="page-title-actions">
                            <div class="d-inline-block dropdown">
                                <a href="howitWorks/addHowitWorks">
                ...
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        <table style="width:100%;" class="table table-hover table-striped table-bordered" id="tblHowitWorks">
                            <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>Title</th>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <input type="hidden" name="howItWorksId" id="howItWorksId">
                <input type="hidden" name="statusForDelete" id="statusForDelete">
...
<!-- Modal Start -->
<div class="modal fade" id="deleteConfirmationModel" tabindex="-1" role="dialog" aria-labelledby="userIsActiveModelLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Confirmation</h5>
            ...
            <div class="modal-body">
                <input type="hidden" name="howItWorksIdForDelete" id="howItWorksIdForDelete">
...
@push('scripts')
    <script src="{{asset('public/assets/js/howItWorks/howItWorks.js')}}"></script>
@endpush
@endsection
