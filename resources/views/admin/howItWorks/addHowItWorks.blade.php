        ...
        <div class="app-main__outer">
            <div class="app-main__inner">
                ...
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        <h5 class="card-title">Add How it Works</h5>
                        <div class="row">
                        ...
                        <form id="addHowitWorks" name="addHowitWorks" class="col-md-10 mx-auto" method="post" action="{{ url('admin/howitWorks/addHowitWorks') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
...
@push('scripts')
<script src="{{asset('public/assets/js/howItWorks/addHowItWorks.js')}}"></script>
@endpush
