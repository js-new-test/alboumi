        ...
        <div class="app-main__outer">
            <div class="app-main__inner">
                ...
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        <table style="width:100%;" class="table table-hover table-striped table-bordered" id="tblBooks">
                            <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>Title</th>
...
<!-- Modal Start -->
<div class="modal fade" id="bookDeleteModel" tabindex="-1" role="dialog" aria-labelledby="userIsActiveModelLabel" aria-hidden="true">
...
<!-- Modal Over -->
@push('scripts')
    <script src="{{asset('public/assets/js/books/books.js')}}"></script>
@endpush
@endsection
