...
<title>Edit Home Page Text | Alboumi</title>
        ...
        <div class="app-main__outer">
            <div class="app-main__inner">
                ...
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        <h5 class="card-title">Update Home Page Text</h5>  
                        <form id="homePageTextForm" class="footerGeneratorForm" method="post" action="{{url('/admin/home-page-text/update')}}">
                            <input type="hidden" name="_token" id="_token" value="{{ csrf_token() }}" /> 
                            <input type="hidden" name="hpt_id" value="{{$HomePageText->id}}">                                                   
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="language"><strong>Language<span style="color:red">*</span></strong></label>   
                                        <input type="text" disabled name="language" id="language" value="{{$HomePageText->langName}}" class="form-control">                                                                                                                                                                         
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="content_1"><strong>Content 2<span style="color:red">*</span></strong></label>   
                                        <input type="text" name="content_1" id="content_1" value="{{$HomePageText->content_1}}" class="form-control">                                                                                     
                                    </div> 
                                </div>                                
                            </div>    
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="content_2" id="content_2" cols="30" rows="5" class="form-control">{{$HomePageText->content_2}}</textarea>
                                    </div> 
                                </div>
                            </div>                                                                                                                                                                                                                                                                                                                                                                                                                                                                            
                                                                                                                
                            <div class="form-group">
                                <button type="submit" class="btn btn-primary" name="update_text" id="update_text">Update Text</button>
