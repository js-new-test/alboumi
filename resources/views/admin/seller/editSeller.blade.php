        ...
        <div class="app-main__outer">
            <div class="app-main__inner">
                                ...
                                <div class="page-title-subheading opacity-10">
                                    <nav class="" aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item">
                                                <a href="{{url('/admin/sellers')}}">Seller List</a>
                                            </li>
                ...
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        <h5 class="card-title">Edit Seller</h5>
                        <div class="row">
                        ...
                        <form id="editSeller" name="editSeller" class="col-md-10 mx-auto" method="post" action="{{ url('admin/seller/editSeller') }}" enctype="multipart/form-data">
                            ...
                            <div class="row">                                
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input type="text" class="form-control" id="title" name="title" placeholder="Enter Title" value="{{ $seller->title }}" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <select name="status" id="status" class="form-control">
                                                <option {{ ( $seller->status == 'Active' ) ? 'selected' : '' }}>
                                                    Active</option>
                                                <option {{ ( $seller->status == 'Inactive' ) ? 'selected' : '' }}>
                                                    Inactive</option>
                                            </select>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input type="file" name="sellerImage" class="form-control" id="sellerImage">
                                            <small class="form-text text-muted">Image size should be {{config('app.seller_image.width')}} X {{config('app.seller_image.height')}} px.</small>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <!-- <div>
                                            <input name="link" id="link" type="text" class="form-control" placeholder="Enter Link" value="{{ $seller->link }}">
                                        </div> -->
                                        <select name="link" id="link" class="multiselect-dropdown form-control">
                                            @foreach($categories as $category)
                                                <option value="{{$category->parent_cat_id}}" {{($seller->category_id == $category->parent_cat_id) ? 'selected' : ''}}>{{$category->title}}</option>                                            
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input type="text" name="price" class="form-control" id="price" placeholder="Enter Price" value="{{ $seller->price }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input name="sortOrder" id="sortOrder" type="number" class="form-control" placeholder="Enter Sort Order" value="{{ $seller->sort_order }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <select
                                                    ...
                                                    <option value="{{ $language->id }}" {{ $seller->language_id == $language->id ? 'selected' : '' }}>
...
@push('scripts')
<script src="{{asset('public/assets/js/seller/editSeller.js')}}"></script>
@endpush
