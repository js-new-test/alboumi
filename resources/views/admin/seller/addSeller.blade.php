            ...
            <div class="app-main__inner">
                ...
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        ...
                        <form id="addSeller" name="addSeller" class="col-md-10 mx-auto" method="post"
                            action="{{ url('admin/seller/addSeller') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">                                
                                <div class="col-md-6">
...
@push('scripts')
<script src="{{asset('public/assets/js/seller/addSeller.js')}}"></script>
@endpush
