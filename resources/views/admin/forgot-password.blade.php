                    ...
                    <div class="app-logo-inverse mx-auto mb-3"></div>
                        <div class="modal-dialog w-100">
                            <div class="modal-content">
                                ...
                                <form id="forgotPassForm" class="" method="POST" action="{{url('/admin/forgot-password')}}">
                                    @csrf
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-12">
                                                    <div class="position-relative form-group">
                                                        ...
                                                        <input name="forgot_email" id="forgot_email" placeholder="Email" type="text" class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="modal-footer clearfix">
                                        <div class="float-left">
                                            <a href="{{url('/admin/login')}}" class="btn-lg btn btn-link">Back</a>
                                        </div>
