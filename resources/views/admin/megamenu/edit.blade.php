...
<title>Update Megamenu | Alboumi</title>

@section('content')
<script>
    var cms_pages = <?php echo json_encode($cms_pages); ?>;
    var categories = <?php echo json_encode($categories); ?>;
    var type = <?php echo json_encode($menu->type); ?>;
    var small_image = <?php echo json_encode($menu['small_image']);?>;
    var big_image = <?php echo json_encode($menu['big_image']);?>;
    var icon_image = <?php echo json_encode($menu['icon_image']);?>;
    var selected_dropdown = <?php echo json_encode($menu['name']);?>;
        ...
        <div class="app-main__outer">
            <div class="app-main__inner">
                ...
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        <h5 class="card-title">Update Megamenu</h5>
                        <div class="row">
                        ...
                        <form id="updateMegamenuForm" class="col-md-10 mx-auto" method="post"
                            action="{{ url('admin/mega-menu/updateMenu') }}" enctype="multipart/form-data">
                            @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <div class="custom-radio custom-control custom-control-inline">
                                                <input class="custom-control-input" type="radio" id="type_cms" name="type" value="0" onclick="showRelatedBlock(0)"  {{ ($menu['type'] =="0")? "checked" : "" }}>
                                                <label class="custom-control-label" for="type_cms">CMS</label>
                                            </div>
                                            <div class="custom-radio custom-control custom-control-inline">
                                                <input class="custom-control-input" type="radio" id="type_category" name="type" value="1" onclick="showRelatedBlock(1)"  {{ ($menu['type'] =="1")? "checked" : "" }}>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                       <img src="" width="100" height="100" class="mb-3" id="selected_small_pic">
                                </div>
                                <div class="col-md-6">
                                       <img src="" width="100" height="100" class="mb-3" id="selected_big_pic">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <textarea type="text" class="form-control" id="description" name="description"
                                                placeholder="Write description here" rows=4>{{ $menu->description }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input type="number" class="form-control" id="sort_order" name="sort_order"
                                                placeholder="Enter sort order" value="{{ $menu->sort_order }}" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <img src="" width="100" height="100" class="mb-3" id="selected_icon_image">
                                </div>
                            </div>
...
@push('scripts')
<script src="{{asset('public/assets/js/megamenu/editMegamenu.js')}}"></script>
