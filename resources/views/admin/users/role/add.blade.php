            ...
            <div class="app-main__inner">
                ...
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        ...
                        @endif                       -->
                        <form id="roleForm" class="col-md-6" method="post" action="{{url('/admin/user/role/add')}}">
                            @csrf
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn-primary" name="add_role" value="add_role">Add Role</button>                                
