    ...
    <div class="card-body">
        ...
        <form class="col-md-12 mx-auto" name="generalDetails" id="generalDetails" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <input type="hidden" name="editPage" value="GENERALINFO" readonly="true">
                <input type="hidden" name="productId" id="productId" readonly="true">
                <div class="col-md-6">
            ...
            <div class="row commonElement">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="hidden" name="prevCategoryId" id="prevCategoryId">
                        <div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group commonElement">
            ...
            <div class="row d-none ImageRes commonElement">
                <div class="col-md-6">
                    <div class="form-group">
            ...
            <div class="row commonElement">
                ...
                <div class="col-md-5">
                    <div class="form-group">
                        <!-- <div class="position-relative form-check"> -->
                            <label class="font-weight-bold">
                                <input type="checkbox" class="form-check-input" name="flag_deliverydate" id="flag_deliverydate" > Display Delivery Date?
                            </label>
                        <!-- </div> -->
                    </div>
                </div>
            ...
            <div class="row commonElement">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="qty_matrix" class="font-weight-bold mr-3">Printing Product</label>
                        <div style="display:unset">
                            <div class="custom-radio custom-control custom-control-inline">
                                <input class="custom-control-input" type="radio" id="printing_product_no" name="printing_product" value="0">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-2 offset-md-4">
                                <button class="btn btn-primary" type="button" id="generalInfo">Submit</button>
                            </div>
                            <div class="col-md-2">
                                <a href="{{ url('admin/products') }}">
                                    <button type="button" class="btn btn-light btn-shadow w-100" name="cancel" value="Cancel">Cancel</button>
                                </a>
                            </div>
                        </div>
                    </div>
