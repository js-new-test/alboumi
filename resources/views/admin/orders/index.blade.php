...
<title>All Orders | Alboumi</title>
            ...
            <div class="app-main__inner">
                    ...
                    <div class="page-title-wrapper">
                        ...
                        <div class="page-title-actions">
                            <div class="d-inline-block dropdown">
                                ...
                                <button class="mb-2 mr-2 btn-icon btn-square btn btn-primary btn-sm" id="ordersExport"><i class="fa fa-download btn-icon-wrapper"></i>Export</button>
                ...
                <div class="main-card mb-3 card" id="FilterDiv">
                    <div class="card-body">
                        ...
                        <form class="col-md-12 mx-auto" id="filterOrderForm">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input type="text" name="paymentMethod" id="paymentMethod" placeholder="Payment Method" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="font-weight-bold">Shipping Type </label>
                                        <div>
                                            <div class="custom-radio custom-control custom-control-inline">
                                                <input class="custom-control-input" type="radio" id="shipping_type_all" name="shipping_type" value="all" checked>
                                                <label class="custom-control-label" for="shipping_type_all">All</label>
                                            </div>
                                            <div class="custom-radio custom-control custom-control-inline">
                                                <input class="custom-control-input" type="radio" id="shipping_type_delivery" name="shipping_type" value="delivery">
                                                <label class="custom-control-label" for="shipping_type_delivery">Delivery</label>
                                            </div>
                                            <div class="custom-radio custom-control custom-control-inline">
                                                <input class="custom-control-input" type="radio" id="shipping_type_storepickup" name="shipping_type" value="store_pickup">
                                                <label class="custom-control-label" for="shipping_type_storepickup">Store Pickup</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-1 offset-md-5">
                                                <button type="button" id="btnFilterOrders" class="btn btn-primary">Search</button>
                                            </div>
                                            <div class="col-md-1">
                ...
                <div class="main-card mb-3 card">
                    <div class="card-body">
                      <form  action="{{url('/admin/orders/printBulkOrders')}}" method="post"/>
                      @csrf
                      <div class="row">
                        <div class="col-md-12 text-right mr-b2" id="bgWhiteBtns">
                          <button type="button" data-toggle="modal" data-target="#btnMarkAsCancelled" class="btn-icon btn-square btn btn-primary btn-sm" >
                            <i class="fa fa-times-circle"></i> Cancel Order
                          </button>
                          <button type="button" data-toggle="modal" data-target="#generateInvoice" class="btn-icon btn-square btn btn-primary btn-sm" >
                            <i class="pe-7s-ticket"></i> Generate Invoice
                          </button>
                          <button class="btn-icon btn-square btn btn-primary btn-sm printBtn" type="submit" name="submit">
                            <i class="fa fa-print"></i> </i>Print Order
                          </button>
                          <!-- <a id="btnPrintLabelBtn" href="" target="_blank" class="btn-icon btn-square btn btn-primary btn-sm">
                            <i class="fa fa-check-circle"></i>
                            Print Label
                          </a> -->
                        </div>
                      </div>
                        <!-- <select id="bulkActionDropdown" class="multiselect-dropdown">
                            <option value="">Select Action</option>
                            <option value="cancelOrder">Cancel Order</option>
                            <option value="generateInvoice">Generate Invoice</option>
                            <option value="printOrder">Print Order</option>
                            <option value="printLabel">Print Label</option>
                        </select> -->
                        <table style="width:100%;" id="allOrdersList" class="table table-hover table-striped table-bordered">
                            <thead>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                @csrf
                    ...
                    <input type="hidden" name="orderId" id="shippedOrderId" value="">
