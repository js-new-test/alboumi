...
<body>
  ...
  @foreach($dataPdfArr as $data)
    ...
    <img src="{{ public_path('/assets/frontend/img/Alboumi_Logo.png') }}" class="logo" height="80" width="100px">
        <div style="  display: block; float: right; margin-right:0px; position: relative;margin-left: 350px;font-size: 15px !important;">
            ...
            <table width='100%' cellpadding='0' cellspacing='0' border='0' class='pdftbl'>
                ...
                <tr>
                    <td>Order Date </td>
                    <td>: {{ date('M d, Y',strtotime($data['orderDetails']->orderDate)) }}</td>
                </tr>
            </table>
            <br>
        </div>
    ...
    <div class="row" style="margin-top: 150px;padding-top: 20px;">
        <table width='100%' cellpadding='0' cellspacing='0' border='0' class='pdftbl' style="margin-top:12%; font-size: 15px !important;">
            <tr>
            ...
            <tr>
                <td>
                    ...
                    <p class="margin"><i class="fa fa-phone-square"></i> Phone : {{ $data['orderDetails']->b_phone1 }}</p></td>
                <td>
                    @if($data['orderDetails']->shipping_type == 'delivery')
    ...
    <div class="row">
        <table width='100%' cellpadding='0' cellspacing='0' border='0' class='pdftbl' style="margin-top:1%; font-size: 15px !important;">
            <tr>
                <th width="50%">Payment Method : </th>
                <th width="50%"> Shipping Method :</th>
            </tr>
            <tr>
                <td><p class="margin">{{ $data['orderDetails']->payment_method }} </p></td>
    ...
    <div class="row">
        <table width='100%' cellpadding='0' cellspacing='0' border='0' class='pdftbl' style="margin-top:1%; font-size: 15px !important;" id="prodTable">
            <tr>
                <th>Sr. No</th>
                <th>Name</th>
                <th>Price</th>
            ...
            <tr>
                ...
                <td style="border: 1px solid black !important; padding-left:2%;">{{ $productDetail['product_name'] }} <br>
                ...
                <td style="border: 1px solid black !important; padding-left:2%;">{{ $defaultCurrency->currency_code }} {{ $productDetail['price'] }}</td>
                <td class="text-center" style="border: 1px solid black !important; padding-left:2%;">{{ $productDetail['quantity'] }}</td>
                <td style="border: 1px solid black !important; padding-left:4%;">{{ $productDetail['status'] }}</td>
                <td style="border: 1px solid black !important; padding-left:2%;">{{ $defaultCurrency->currency_code }} {{ number_format(($productDetail['quantity'] * $productDetail['price']),$decimalNumber, $decimalSeparator, $thousandSeparator) }}</td>
            </tr>
            @endforeach
            @endif
        </table>
    ...
    <div style="  display: block; float: right; margin-right:0px; position: relative;margin-left: 350px;font-size: 15px !important;">
        ...
        <table width='100%' cellpadding='0' cellspacing='0' border='0' class='pdftbl'>
            <tr>
                ...
                <td><b>: {{ $defaultCurrency->currency_code }} {{ number_format($data['orderDetails']->subtotal,$decimalNumber, $decimalSeparator, $thousandSeparator) }}</b></td>
            </tr>
            @if($data['orderDetails']->discount_amount > 0)
            <tr>
                <td><b>Order Discount ({{ $data['orderDetails']->promotions }}) </b></td>
                <td><b>: {{ $defaultCurrency->currency_code }} {{ number_format($data['orderDetails']->discount_amount,$decimalNumber, $decimalSeparator, $thousandSeparator) }}</b></td>
            </tr>
            <tr>
                <td><b>Price After Discount</b></td>
                <td><b>: {{ $defaultCurrency->currency_code }} {{ number_format(($data['orderDetails']->subtotal - $data['orderDetails']->discount_amount),$decimalNumber, $decimalSeparator, $thousandSeparator) }}</b></td>
            </tr>
            @endif
            <tr>
                <td><b>Shipping Cost</b></td>
                <td><b>: {{ $defaultCurrency->currency_code }} {{ number_format($data['orderDetails']->total_shipping_cost,$decimalNumber, $decimalSeparator, $thousandSeparator) }}</b></td>
            </tr>
            <tr>
                <td><b>Tax</b></td>
                <td><b>: {{ $defaultCurrency->currency_code }} {{ number_format($data['orderDetails']->tax_amount,$decimalNumber, $decimalSeparator, $thousandSeparator) }}</b></td>
            </tr>
            <tr>
                <td><b>Grand Total</b></td>
                <td><b>: {{ $defaultCurrency->currency_code }} {{ number_format($data['orderDetails']->total,$decimalNumber, $decimalSeparator, $thousandSeparator) }}</b></td>
            </tr>
        </table>
        <br>
    </div>
