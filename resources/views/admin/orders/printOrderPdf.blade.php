...
<body>
    ...
    <div class="page-header">
        ...
        <div style="  display: block; float: right; margin-right:0px; position: relative;margin-left: 350px;font-size: 15px !important;">
            ...
            <table width='100%' cellpadding='0' cellspacing='0' border='0' class='pdftbl'>
                ...
                <tr>
                    <td>Order Date </td>
                    <td>: {{ date('M d, Y',strtotime($orderDetails->orderDate)) }}</td>
                </tr>
                @if(!empty($orderDetails->loyalty_card))
                <tr>
                    <td>Loyalty Number </td>
                    <td>: {{ $orderDetails->loyalty_card }}</td>
                </tr>
                @endif
            </table>
            <br>
        ...
        <table width='100%' cellpadding='0' cellspacing='0' border='0' class='pdftbl' style="margin-top:12%; font-size: 15px !important;">
            ...
            <tr>
                <td>
                    ...
                    <p class="margin"><i class="fa fa-phone-square"></i> Phone : {{ $orderDetails->b_phone1 }}</p></td>
                <td>
                    @if($orderDetails->shipping_type == 'delivery')
    ...
    <div class="row">
        <table width='100%' cellpadding='0' cellspacing='0' border='0' class='pdftbl' style="margin-top:1%; font-size: 15px !important;">
            ...
            <tr>
                <td><p class="margin">{{ $orderDetails->payment_method }} </p></td>
    ...
    <div style="  display: block; float: right; margin-right:0px; position: relative;margin-left: 350px;font-size: 15px !important;">
        ...
        <table width='100%' cellpadding='0' cellspacing='0' border='0' class='pdftbl'>
            <tr>
                ...
                <td><b>: {{ $defaultCurrency->currency_code }} {{ number_format($orderDetails->subtotal,$decimalNumber, $decimalSeparator, $thousandSeparator) }}</b></td>
            </tr>
            @if($orderDetails->discount_amount > 0)
            <tr>
                <td><b>Order Discount ({{ $orderDetails->promotions }}) </b></td>
                <td><b>: {{ $defaultCurrency->currency_code }} {{ number_format($orderDetails->discount_amount,$decimalNumber, $decimalSeparator, $thousandSeparator) }}</b></td>
            </tr>
            <tr>
                <td><b>Price After Discount</b></td>
                <td><b>: {{ $defaultCurrency->currency_code }} {{ number_format(($orderDetails->subtotal - $orderDetails->discount_amount),$decimalNumber, $decimalSeparator, $thousandSeparator) }}</b></td>
            </tr>
            @endif
            <tr>
                <td><b>Shipping Cost</b></td>
                <td><b>: {{ $defaultCurrency->currency_code }} {{ number_format($orderDetails->total_shipping_cost,$decimalNumber, $decimalSeparator, $thousandSeparator) }}</b></td>
            </tr>
            <tr>
                <td><b>Tax</b></td>
                <td><b>: {{ $defaultCurrency->currency_code }} {{ number_format($orderDetails->tax_amount,$decimalNumber, $decimalSeparator, $thousandSeparator) }}</b></td>
            </tr>
            <tr>
                <td><b>Grand Total</b></td>
                <td><b>: {{ $defaultCurrency->currency_code }} {{ number_format($orderDetails->total,$decimalNumber, $decimalSeparator, $thousandSeparator) }}</b></td>
            </tr>
        </table>
        <br>
    </div>
