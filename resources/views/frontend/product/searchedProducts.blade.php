...
<script>
    ...
    var pageName = "searchResultFilter";
    var searchVal = <?php echo json_encode($searchVal);?>
</script>
<div id="ajax-loader">
...
@if(count($filteredProducts) > 0 && !empty($filteredProducts[0]))
			  ...
			  <p class="s1">{{ $productSortLabels['FILTERBY'] }} :</p>
			    <div class="acco-tabs">
					...
					<div class="acco-tab" id="brandOptions">
						...
						<div class="acco-tab-content">
							<input class="filterTitle" type ="hidden" name="brand_id" id="brand_id" value="Brands">
					...
					<div class="acco-tab attrTab_{{ $group['filterId'] }} attr_tabs_class" id="attributeTab_{{ $group['filterId'] }}">
						...
						<div class="acco-tab-content items color-items">
					...
					@endif
					<!-- <div id="attributeOptions" class="attributeOptions"></div> -->
	  	...
	  	<div class="col-md-8 col-lg-9 pad-top-40 pad-bottom-64">
			<div class="row listing-head">
				<div class="col-12 col-sm-12 col-md-6">
					<h4>{{ $productSortLabels['SEARCHRESULTFOR'] }} "{{ $searchVal }}"</h4>
				</div>
