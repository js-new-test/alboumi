					...
					<div class="pl-24">
						<div class="right-side-items">
							<div class="my-addresses">
								<h4 class="profile-header">{{$myAddressLabels['BILLINGADDRESS']}}</h4>
								...
								@endif
								<form id="frontMyBillingAddressForm" class="row" method="POST" action="{{url('/customer/billing-address')}}">
									...
									<div class="col-sm-12 col-md-10 col-lg-6 col-xl-5">
										<div class="row">
											<div class="col-sm-12">
												<input type="text" class="input" placeholder="{{$myAddressLabels['MYADDRESSES9']}}" name="full_name" id="full_name" value="{{($cust_default_bill_address) ? $cust_default_bill_address->fullname : ''}}">
											...
											<div class="col-sm-12">
												<input type="number" class="input" placeholder="{{$myAddressLabels['MYACCOUNTLABEL3']}}" name="mobile" id="mobile" value="{{($cust_default_bill_address) ? $cust_default_bill_address->phone1 : ''}}">
...
@endsection
@push('scripts')
<script src="{{asset('/public/assets/frontend/js/billing-address/billing-address.js')}}"></script>
